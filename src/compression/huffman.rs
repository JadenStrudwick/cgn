...
//! use cgn::compression::huffman::{compress_pgn_data, decompress_pgn_data, huffman_compress_pgn_str, huffman_decompress_pgn_str};
//! use bit_vec::BitVec;
//! use std::str::FromStr;
//!
...
//! let compressed_bytes: Vec<u8> = huffman_compress_pgn_str(PGN_STR_EXAMPLE);
//! let decompressed_pgn_str: String = huffman_decompress_pgn_str(&compressed_bytes);
