...
//! use cgn::compression::bincode::{compress_pgn_data, decompress_pgn_data, bincode_compress_pgn_str, bincode_decompress_pgn_str};
//! use bit_vec::BitVec;
//! use std::str::FromStr;
//!
...
//! let compressed_bytes: Vec<u8> = bincode_compress_pgn_str(PGN_STR_EXAMPLE);
//! let decompressed_pgn_str: String = bincode_decompress_pgn_str(&compressed_bytes);
//! assert_eq!(PGN_STR_EXAMPLE, decompressed_pgn_str);
//! ```

use crate::compression::utils::export_to_wasm;
